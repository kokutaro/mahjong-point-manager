...
export const GameStatusSchema = z.enum(['WAITING', 'STARTING', 'PLAYING', 'FINISHED', 'CANCELLED'])
 ...
 */
export function getPlayerPosition(identifier: PlayerIdentifier, gameMode: GameMode): number {
  if (gameMode === 'SOLO') {
